...
def lambda_handler(event, context):
    ...
    myJob = glue.create_job(Name='intellidata-google-member-job', Role='AWSGlueServiceRole', Command={'Name': 'glueetl', 'ScriptLocation': 's3://aws-glue-scripts-321504535921-us-east-1/root/intellidata-google-member-job'})
